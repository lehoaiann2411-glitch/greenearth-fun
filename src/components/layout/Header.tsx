...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      ...
      <div className="container relative flex h-20 sm:h-28 md:h-40 items-center justify-between">
        <Link to="/" className="flex items-center group relative max-w-[160px] sm:max-w-[200px] md:max-w-none">
          <GreenEarthLogo className="relative z-10 h-36 sm:h-48 md:h-72 w-auto transition-transform duration-300 group-hover:scale-105" />
        </Link>
